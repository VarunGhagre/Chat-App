  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative flex flex-col backdrop-blur-lg'>
      ...
      {/* <div className="p-4 text-white">
        <p className="text-sm text-gray-300">Chatting with <span className='font-semibold'>{selectedUser.fullName}</span>...</p>
      </div> */}
      ...
      <div className='flex flex-col h-[calc(100% - 120px)] overflow-y-scroll p-3 pb-20'>
          ...
          <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-black'>
            <div className='flex-1 flex items-center bg-gray-100/12 px-13 rounded-full'>
              ...
              <input onChange={hanleSendImage} type="file" id='image' accept='image/png, image/jpeg' hidden/>
              <label htmlFor="image">
